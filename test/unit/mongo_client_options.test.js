...
describe('MongoOptions', function () {
  ...
  context('when loadBalanced=true is in the URI', function () {
    ...
    it.only('errors with a replicaSet option', function () {
      const parse = () => {
    ...
    it.only('errors with a directConnection option', function () {
      const parse = () => {
